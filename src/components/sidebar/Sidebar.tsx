                ...
                <div className="w-full space-y-4">
                    {routes?.map((route) => (
                        <Link
                            ...
                            href={route.href}
                            className={cn(
                                "flex items-center justify-start w-full xl:px-5 py-2.5 font-medium group transition transform duration-300 active:scale-90 rounded-xl font-base hover:bg-slate-100 text-slate-700",
